...
WEUDEF void qweu_bitfield_8_print(weu_bitfield_8 bf) {
    _print_bitfield(bf, 0x80, 8);
    printf("\n");
}
WEUDEF void qweu_bitfield_32_print(weu_bitfield_32 bf) {
    _print_bitfield(bf, 0x80000000, 32);
    printf("\n");
}
WEUDEF void qweu_bitfield_64_print(weu_bitfield_64 bf) {
